...
int main(){
	...
	for (int i = 0; i < numOfCases; i++)
	{
		...
		items = (int *)malloc(sizeof(int)*numOfItems);
		...
		sortedFirst = firstFit(items, numOfItems, binCapacity);
		...
		cout << "Test Case " << i+1 << " ";
		cout << "First Fit: "<< firstFitBins << ", " << ((ffDiffer.tv_sec * 1000000000) + ffDiffer.tv_nsec) << ".";
		cout << "First Fit Decreasing: " << sortedFirst << ", " << ((ffdDiffer.tv_sec * 1000000000) + ffdDiffer.tv_nsec) << ".";
		cout << "Best Fit: " << numBestFit << ", " << ((bfDiffer.tv_sec * 1000000000) + bfDiffer.tv_nsec) << "." << endl;
